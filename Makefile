...
tb test-backend:
	docker exec walmart-tester-local sh -c 'cd /app/backend && pwd && ls -a && npm run test'

tf test-frontend:
	docker exec walmart-tester-local sh -c 'cd /app/frontend && pwd && ls -a && npm run test-no-watch'
